...
.. warning::
    It is not secure to use the telnet console via public networks, as telnet
    ...
    Please avoid using the telnet console over insecure connections,
    or disable it completely using the :setting:`TELNETCONSOLE_ENABLED` option.
...
The telnet console listens at the TCP port defined in the
...
+----------------+-------------------------------------------------------------------+
| ``engine``     | :attr:`Crawler.engine` attribute                                          |
+----------------+-------------------------------------------------------------------+
| ``spider``     | the active spider                                                 |
+----------------+-------------------------------------------------------------------+
| ``slot``       | the engine slot                                                   |
+----------------+-------------------------------------------------------------------+
| ``extensions`` | the Extension Manager (:attr:`Crawler.extensions` attribute)              |
+----------------+-------------------------------------------------------------------+
| ``stats``      | the Stats Collector (:attr:`Crawler.stats` attribute)                     |
+----------------+-------------------------------------------------------------------+
| ``settings``   | the Scrapy settings object (:attr:`Crawler.settings` attribute)           |
+----------------+-------------------------------------------------------------------+
...
You can use the :meth:`est()` method of the Scrapy engine to quickly show its state
